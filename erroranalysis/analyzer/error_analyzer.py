...
class BaseAnalyzer(ABC):
    ...
    """
    def __init__(self, dataset, true_y, feature_names, categorical_features, model_task, metric, classes):
        ...
        if self._categorical_features:
            self._categorical_indexes = [feature_names.index(feature) for feature in self._categorical_features]
            
            ordinal_enc = OrdinalEncoder()
            ct = ColumnTransformer([('ord', ordinal_enc, self._categorical_indexes)], remainder='drop')
